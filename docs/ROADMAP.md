...
| Sprint | Temat | Co dostarcza |
|--------|-------|--------------|
| 15 | **Launch Readiness** ✅ closed 2026-05-25 | README EN przepisany (136 linii, all-absolute links), `webox provider new <name> [--preset]` generator (cPanel-UAPI / DirectAdmin / CyberPanel / blank), `docs/contributing/PROVIDER.md` 4-hour walkthrough, slim `AGENTS.md` (≤150 linii) + 3 nowe specialist docs, root EN `CONTRIBUTING.md`, 5 launch-day `good-first-issue` body drafts (`.github/issue-drafts/`), Apache-2.0 backfill (README/PRD/landing/skills), repo public-readiness audit (provider-request issue form, FUNDING.yml, mockup convention note). **Carry-over → Sprint 16:** asciinema cast + dashboard PNG (operator-only, scripts ready), landing EN body translation (native-speaker pass). Patrz [sprint-15](./sprints/sprint-15-launch-readiness.md) + [retro](./retros/2026-05-25-sprint-15.md). |
