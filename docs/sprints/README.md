...
| 22 | **cPanel Adapter (part 2) + v0.2.0-rc1** — mutating ops (`createProject`, `restartApp`, `addSSLDomain`), wizard integration, GHA template, E2E, fixtures from live test account (TASK-21.7 carry-over), release. | 🟡 Partial — merged dormant 2026-06-09 (5/8: 22.1–22.5; mutations gated behind `WEBOX_CPANEL_MUTATIONS=1`). TASK-22.0 (live fixtures), 22.6 (`v0.2.0-rc1` tag), TUI provider-picker → Sprint 24. | [sprint-22-cpanel-adapter-mutations.md](sprint-22-cpanel-adapter-mutations.md) | [2026-05-26-sprint-22.md](../retros/2026-05-26-sprint-22.md) |
...
- **Sprint 22** — cPanel Adapter part 2 + v0.2.0-rc1 (mutating ops, wizard, GHA template, E2E, live-account fixtures, release). Merged dormant 2026-06-09 (5/8 done; mutations gated behind `WEBOX_CPANEL_MUTATIONS=1`); TASK-22.0 live fixtures + 22.6 rc1 tag → Sprint 24, gated on operator cPanel credential rotation.
